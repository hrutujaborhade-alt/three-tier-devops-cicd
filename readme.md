...
The Jenkins server is hosted on an AWS EC2 instance and is configured to integrate with the GitHub repository.
...
- Later deploy the application to Amazon EKS
